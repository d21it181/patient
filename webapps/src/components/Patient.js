...
export default function Student(props) {
  ...
  useEffect(() => {
    ...
    if (pId != null) {
      setLoading(true);
      axios
        .get("https://8080-mayurhere-patient-vxkyz1w2z2e.ws-us65.gitpod.io/patient/" + pId)
        .then((response) => {
  ...
  let saveStudent = (event) => {
    ...
    axios.post("https://8080-mayurhere-patient-vxkyz1w2z2e.ws-us65.gitpod.io/patient", patient)
      .then(response => {
  ...
  let updatePatient = (event) => {
    event.preventDefault();
    setLoading(true);
    axios.put("https://8080-mayurhere-patient-vxkyz1w2z2e.ws-us65.gitpod.io/patient/" + patientId, patient).then((response) => {
      if (response.data != null) {
        setLoading(false);
